...
Alternatively, if you don't want to get the stripped version of mimic-iv: within the `scripts/darwin/config.py` change the value of the `origin_root` variable to point to the root folder of where on your computer you have the mimic-iv data stored.
