...
train_dataset = pneumonia_dataset.MIMIC_Pneumonia_Dataset(imgpath=external_images_path,
...
test_dataset = pneumonia_dataset.MIMIC_Pneumonia_Dataset(imgpath=external_images_path,
                                     csvpath=cxr_negbio_csv,
                                     metacsvpath=cxr_metadata_csv,
                                     option='test',
                                     pre_processed=False,
...
valid_dataset = pneumonia_dataset.MIMIC_Pneumonia_Dataset(imgpath=external_images_path,
                                     csvpath=cxr_negbio_csv,
                                     metacsvpath=cxr_metadata_csv,
                                     option='valid',
                                     pre_processed=False,
