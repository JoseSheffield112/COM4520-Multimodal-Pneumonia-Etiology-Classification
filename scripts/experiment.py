...
def main():
    ...
    print("Performing experiment {} on the {} model for {} epochs and {} runs. \nThe results will be stored in the {} directory".format(args.experimentName,args.model,str(args.numEpochs),str(args.numRuns),modelResultsDir))
    ...
    if (args.model == "static"):
        models.mimic_static.runModel(args.numRuns,modelResultsDir,args.numEpochs)
    elif (args.model == "image"):
        models.mimic_image.runModel(args.numRuns,modelResultsDir,args.numEpochs)
    elif (args.model == "image_static"):
        models.mimic_image_static.runModel(args.numRuns,modelResultsDir,args.numEpochs)
