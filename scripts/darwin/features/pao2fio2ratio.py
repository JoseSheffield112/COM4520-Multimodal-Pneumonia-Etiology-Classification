...
import config.darwin.config as const
...
def getConnection(db='mimiciv'):
    '''
    Returns a connection to a specified database by using a configuration file whose path is specified in the config.config python module.
    '''
